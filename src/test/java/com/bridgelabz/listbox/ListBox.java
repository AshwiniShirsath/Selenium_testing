...
/*
 * Program:Write a script to select few elements in the list box
 */
...
public class ListBox {
	...
	public static void listBox() {
		...
		if (multiple) {
			...
			System.out.println(firstSelectedOption1.getText() + " is the second selected item");
			...
			System.out.println(firstSelectedOption2.getText() + " is the third selected item");
